...
export const Users: React.FC = () => {
  ...
  return (
    <div className="space-y-6 animate-fade-in max-w-7xl mx-auto pb-10">
      ...
      {showModal && (
        <div className="fixed inset-0 z-[200] flex items-start md:items-center justify-center overflow-y-auto bg-brand-navy/60 backdrop-blur-md animate-fade-in no-scrollbar pt-10 md:pt-4">
