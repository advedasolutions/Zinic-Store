      ...
      <div className="w-full max-w-xl space-y-12">
        ...
        <div className="pt-12 flex flex-col items-center text-center space-y-8">
          ...
          <div className="flex flex-col items-center space-y-6">
            ...
            >
              {/* White background container for the logo to ensure visibility of dark logos */}
              <div className="p-8 bg-white rounded-[2.5rem] shadow-xl border border-slate-100 group-hover:shadow-[0_20px_50px_rgba(0,0,0,0.1)] transition-all">
                <img 
              ...
              <div className="flex flex-col items-center">
                <span className="text-base font-black text-brand-navy tracking-tight group-hover:text-brand-accent transition-colors">ADVEDA SOLUTIONS</span>
