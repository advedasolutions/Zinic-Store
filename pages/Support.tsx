  ...
  return (
    <div className="min-h-screen lg:min-h-[85vh] flex flex-col items-center justify-start lg:justify-center p-4 md:p-8 animate-fade-in bg-[#f8fafc]">
      <div className="w-full max-w-2xl space-y-10 lg:space-y-14">
        ...
        {/* Minimalist 3D Branding Section */}
        <div className="pt-16 pb-12 flex flex-col items-center">
          ...
          >
            ...
            <div className="relative w-48 h-48 lg:w-56 lg:h-56 flex items-center justify-center">
              ...
              <div className="absolute inset-0 border border-slate-200 rounded-[3.5rem] opacity-20 group-hover:scale-110 group-hover:rotate-12 transition-all duration-1000"></div>
              <div className="absolute inset-4 border border-brand-accent/20 rounded-[3rem] opacity-0 group-hover:opacity-100 group-hover:scale-105 group-hover:-rotate-6 transition-all duration-700 delay-75"></div>

              {/* Main 3D Logo Card with Dark Gradient Background */}
              <div className="relative w-36 h-36 lg:w-44 lg:h-44 bg-gradient-to-br from-brand-navy to-brand-deep rounded-[3rem] shadow-[0_30px_60px_rgba(0,0,0,0.15)] group-hover:shadow-[0_40px_80px_rgba(0,0,0,0.25)] border border-white/5 group-hover:border-brand-accent/30 transition-all duration-500 transform group-hover:-translate-y-4 group-hover:rotate-2 overflow-hidden">
                {/* Internal Layering for Depth */}
                <div className="absolute inset-0 bg-gradient-to-tr from-brand-accent/5 to-transparent"></div>
                ...
                <div className="absolute inset-8 flex items-center justify-center">
                  <div className="w-full h-full relative">
                    <img 
                      ...
                      className="w-full h-full object-contain filter drop-shadow-[0_4px_10px_rgba(0,0,0,0.3)] brightness-110 transition-transform duration-700 group-hover:scale-110"
                    />
                  </div>
                </div>
              ...
              <div className="absolute bottom-2 left-1/2 -translate-x-1/2 w-28 h-4 bg-black/10 blur-xl rounded-full scale-150 group-hover:scale-110 group-hover:opacity-50 transition-all duration-500"></div>
            </div>
          </a>
        </div>
      </div>
