...
export const Vendors: React.FC = () => {
  ...
  const canManageFinance = session.user?.role === UserRole.SUPERADMIN || 
                           ...
                           session.user?.permissions?.includes('vendors:modify');
  ...
  return (
    <div className="space-y-10 animate-fade-in pb-10 max-w-6xl mx-auto">
      ...
      {showVendorModal && (
        <div className="fixed inset-0 z-[100] flex items-start md:items-center justify-center p-4 bg-brand-navy/60 backdrop-blur-md animate-fade-in overflow-y-auto no-scrollbar pt-10 md:pt-4">
          <div className="bg-white rounded-[3rem] shadow-2xl w-full max-w-md overflow-hidden my-auto">
      ...
      {showInvoiceModal && selectedVendor && (
        <div className="fixed inset-0 z-[110] flex items-start md:items-center justify-center p-4 bg-brand-navy/70 backdrop-blur-md animate-fade-in overflow-y-auto no-scrollbar pt-10 md:pt-4">
          <div className="bg-white rounded-[3.5rem] shadow-2xl w-full max-w-2xl my-auto animate-slide-up h-[80vh] md:h-auto">
            ...
            <form onSubmit={handleSaveInvoice} className="p-10 space-y-8 flex-1 overflow-y-auto no-scrollbar">
