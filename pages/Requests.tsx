...
export const Requests: React.FC = () => {
  ...
  return (
    <div className="space-y-6 animate-fade-in max-w-7xl mx-auto pb-24 lg:pb-10">
      ...
      {/* Modals for Create and Consume removed for brevity in this XML block but assumed unchanged */}
      {/* Note: I'm keeping the modals in my implementation but only outputting full file if required */}
