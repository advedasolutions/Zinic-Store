...
export const Layout: React.FC<LayoutProps> = ({ children, currentPage, onNavigate }) => {
  ...
  const menuItems = isSuperAdmin ? [
    ...
    { id: 'inventory', label: 'Stock', icon: ICONS.Inventory },
    { id: 'requests', label: 'Orders', icon: ICONS.Requests },
    { id: 'reports', label: 'Insights', icon: ICONS.Report },
    { id: 'users', label: 'Team', icon: ICONS.Users },
    { id: 'vendors', label: 'Vendors', icon: ICONS.Truck },
    { id: 'support', label: 'Help', icon: ICONS.Support },
    { id: 'settings', label: 'Settings', icon: ICONS.Settings },
  ];
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row w-full overflow-x-hidden bg-[#f8fafc] selection:bg-brand-accent selection:text-brand-navy">
      ...
      <div className="lg:hidden fixed bottom-0 left-0 right-0 z-[200] pb-safe">
        ...
        >
          {/* Subtle Edge Faders for Scroll Discovery */}
